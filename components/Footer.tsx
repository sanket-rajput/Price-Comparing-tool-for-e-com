...
const App: React.FC = () => {
  return (
    <footer>
      ...
      <div className="bg-gradient-to-b from-gray-800 via-gray-800 to-transparent dark:from-gray-800 dark:via-gray-800 dark:to-transparent pt-1">
        <div className="container m-auto space-y-8 px-6 text-gray-600 dark:text-black md:px-12 lg:px-20">
          <div className="grid grid-cols-8 gap-6 md:gap-0">
            <div className="col-span-8 border-r border-gray-50 dark:border-gray-800 md:col-span-2 lg:col-span-3">
              <div className="flex items-center justify-between gap-6 border-b border-white dark:border-gray-800 py-6 md:block md:space-y-6 md:border-none md:py-0">
                <img src="/assets/icons/Logo.svg" alt="logo tailus" width="100" height="42" className="w-32 dark:brightness-200 dark:grayscale" />
                <div className="flex gap-6">
                  <a href="#" target="_blank" aria-label="github" className="hover:text-cyan-600">
                    <svg xmlns="http://www.w3.org/2000/svg" width="20" height="20" fill="currentColor" className="bi bi-github" viewBox="0 0 16 16">
                      <path
                        d="M8 0C3.58 0 0 3.58 0 8c0 3.54 2.29 6.53 5.47 7.59.4.07.55-.17.55-.38 0-.19-.01-.82-.01-1.49-2.01.37-2.53-.49-2.69-.94-.09-.23-.48-.94-.82-1.13-.28-.15-.68-.52-.01-.53.63-.01 1.08.58 1.23.82.72 1.21 1.87.87 2.33.66.07-.52.28-.87.51-1.07-1.78-.20-3.64-.89-3.64-3.95 0-.87.31-1.59.82-2.15-.08-.2-.36-1.02.08-2.12 0 0 .67-.21 2.2.82.64-.18 1.32-.27 2-.27.68 0 1.36.09 2 .27 1.53-1.04 2.2-.82 2.2-.82.44 1.10.16 1.92.08 2.12.51.56.82 1.27.82 2.15 0 3.07-1.87 3.75-3.65 3.95.29.25.54.73.54 1.48 0 1.07-.01 1.93-.01 2.20 0 .21.15.46.55.38A8.012 8.012 0 0 0 16 8c0-4.42-3.58-8-8-8z"
                      />
                    </svg>
                  </a>
                  <a href="#" target="_blank" aria-label="twitter" className="hover:text-cyan-600">
                  ...
                  <a href="#" target="_blank" aria-label="medium" className="hover:text-cyan-600">
            ...
            <div className="col-span-8 md:col-span-6 lg:col-span-5">
              <div className="grid grid-cols-2 gap-6 pb-16 sm:grid-cols-3 md:pl-16">
                <div>
                  <h6 className="text-lg font-medium text-gray-800 dark:text-black">Company</h6>
                ...
                <div>
                  <h6 className="text-lg font-medium text-gray-800 dark:text-black">Products</h6>
                  <ul className="mt-4 list-inside space-y-4">
                    <li>
                      <a href="#" className="transition hover:text-cyan-600">
                        About
                ...
                <div>
                  <h6 className="text-lg font-medium text-gray-800 dark:text-black">Resources</h6>
                  <ul className="mt-4 list-inside space-y-4">
                    <li>
                      <a href="#" className="transition hover:text-cyan-600">
                        About
              ...
              <div className="flex justify-between border-t  py-4 pb-8 md:pl-16">
